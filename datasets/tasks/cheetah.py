...
def get_model_and_assets_general(mode):
    """Returns a tuple containing the model XML string and a dict of assets."""
    return resources.GetResource(os.path.join(_TASKS_DIR, f'cheetah_variants/cheetah_{mode}.xml')), common.ASSETS

@cheetah.SUITE.add('custom')
def twoback_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('2_back'))
...
@cheetah.SUITE.add('custom')
def threeback_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('3_back'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def fourback_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('4_back'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def fiveback_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('5_back'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def sixback_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('6_back'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
# @cheetah.SUITE.add('custom')
# def twofront_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
#   """Returns the run task."""
#   physics = Physics.from_xml_string(*get_model_and_assets_general('2_front'))
#   task = cheetah.Cheetah(random=random)
#   environment_kwargs = environment_kwargs or {}
#   return control.Environment(physics, task, time_limit=time_limit,
#                              **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def threefront_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('3_front'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def fourfront_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('4_front'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def fivefront_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('5_front'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def sixfront_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('6_front'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def threebalanced_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('3_balanced'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def fivebalanced_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('5_balanced'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def fourallback_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('4_allback'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
...
@cheetah.SUITE.add('custom')
def fourallfront_run(time_limit=cheetah._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the run task."""
  physics = Physics.from_xml_string(*get_model_and_assets_general('4_allfront'))
  task = cheetah.Cheetah(random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(physics, task, time_limit=time_limit,
                             **environment_kwargs)
