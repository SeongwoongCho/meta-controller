...
def get_model_and_assets_general(mode):
    """Returns a tuple containing the model XML string and a dict of assets."""
    return resources.GetResource(os.path.join(_TASKS_DIR, f'walker_variants/walker_{mode}.xml')), common.ASSETS

@walker.SUITE.add('custom')
def two_run(time_limit=walker._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the Run task."""
  physics = walker.Physics.from_xml_string(*get_model_and_assets_general(2))
...
@walker.SUITE.add('custom')
def three_run(time_limit=walker._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the Run task."""
  physics = walker.Physics.from_xml_string(*get_model_and_assets_general(3))
  task = walker.PlanarWalker(move_speed=walker._RUN_SPEED, random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(
      physics, task, time_limit=time_limit, control_timestep=walker._CONTROL_TIMESTEP,
...
@walker.SUITE.add('custom')
def four_run(time_limit=walker._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the Run task."""
  physics = walker.Physics.from_xml_string(*get_model_and_assets_general(4))
  task = walker.PlanarWalker(move_speed=walker._RUN_SPEED, random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(
      physics, task, time_limit=time_limit, control_timestep=walker._CONTROL_TIMESTEP,
...
@walker.SUITE.add('custom')
def five_run(time_limit=walker._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the Run task."""
  physics = walker.Physics.from_xml_string(*get_model_and_assets_general(5))
  task = walker.PlanarWalker(move_speed=walker._RUN_SPEED, random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(
      physics, task, time_limit=time_limit, control_timestep=walker._CONTROL_TIMESTEP,
...
@walker.SUITE.add('custom')
def six_run(time_limit=walker._DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the Run task."""
  physics = walker.Physics.from_xml_string(*get_model_and_assets_general(6))
  task = walker.PlanarWalker(move_speed=walker._RUN_SPEED, random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(
      physics, task, time_limit=time_limit, control_timestep=walker._CONTROL_TIMESTEP,
